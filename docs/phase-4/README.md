...
The live trigger covers clinician doctor consults, staff nurse consults, and
patient AI sessions. Patients see status only; generated summaries remain in
the authorized clinical timeline.
...
| [P4-T02](task-02-durable-job-schema-and-api.md) | Durable job schema and API | Submission/claim/failure implemented; hosted concurrency pending | 1.25 h | 30 min | T01, Phase 1 RLS | Idempotent submission and caller-visible status |
...
| [P4-T04](task-04-provider-gateway-and-worker.md) | Provider gateway and worker | Implemented locally; genuine durable hosted job pending | 1.5 h | 45 min | T02-T03 | Redacted genuine invocation with retry-safe worker |
| [P4-T05](task-05-ai-entry-and-provenance-persistence.md) | AI entry and provenance persistence | Implemented locally; hosted/genuine evidence pending | 1 h | 30 min | T03-T04, Phase 3 schema | Atomic system entry, version, highlights, audit, and exact source linkage |
