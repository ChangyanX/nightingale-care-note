...
| [P5-T04](task-04-glance-performance-benchmark.md) | Glance performance benchmark | Local approximation/script complete; hosted run pending | 0.75 h | 25 min | Stable Glance API, hosted/local data | Reproducible P50/P95/P99 report |
